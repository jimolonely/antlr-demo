...
public class CalParser extends Parser {
    ...
    public static final int
            T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, WS = 7, DIGIT = 8;
    public static final int
    ...
    private static String[] makeSymbolicNames() {
        return new String[]{
                null, null, null, null, null, null, null, "WS", "DIGIT"
        };
    }
    ...
    public static class LineContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(CalParser.EOF, 0);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CalListener) ((CalListener) listener).enterLine(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CalListener) ((CalListener) listener).exitLine(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalVisitor) return ((CalVisitor<? extends T>) visitor).visitLine(this);
    ...
    public static class ParentExprContext extends ExprContext {
        ...
        public ParentExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CalListener) ((CalListener) listener).enterParentExpr(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CalListener) ((CalListener) listener).exitParentExpr(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalVisitor) return ((CalVisitor<? extends T>) visitor).visitParentExpr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IntContext extends ExprContext {
        public TerminalNode DIGIT() {
            return getToken(CalParser.DIGIT, 0);
        }
