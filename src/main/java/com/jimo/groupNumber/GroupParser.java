...
public class GroupParser extends Parser {
    ...
    public static class FileContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GroupListener) ((GroupListener) listener).enterFile(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GroupListener) ((GroupListener) listener).exitFile(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GroupVisitor) return ((GroupVisitor<? extends T>) visitor).visitFile(this);
    ...
    public static class GroupContext extends ParserRuleContext {
        ...
        public TerminalNode INT() {
            return getToken(GroupParser.INT, 0);
        }
    ...
    public final GroupContext group() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(12);
                sequence((((GroupContext) _localctx).INT != null ?
                        Integer.valueOf(((GroupContext) _localctx).INT.getText()) : 0));
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public static class SequenceContext extends ParserRuleContext {
        ...
        public List<TerminalNode> INT() {
            return getTokens(GroupParser.INT);
        }

        public TerminalNode INT(int i) {
            return getToken(GroupParser.INT, i);
        }
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GroupListener) ((GroupListener) listener).enterSequence(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GroupListener) ((GroupListener) listener).exitSequence(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GroupVisitor) return ((GroupVisitor<? extends T>) visitor).visitSequence(this);
            else return visitor.visitChildren(this);
        }
    }
