// Generated from D:/workspace/demo/antlr-demo/src/main/java/com/jimo/csv\CSV.g4 by ANTLR 4.8
...
public class CSVBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CSVVisitor<T> {
     ...
     */
    @Override
    public T visitHeader(CSVParser.HeaderContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitField(CSVParser.FieldContext ctx) {
        return visitChildren(ctx);
    }
}